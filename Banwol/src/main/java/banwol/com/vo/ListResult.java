...
public class ListResult {
	...
	public ListResult() {}
	public ListResult(int currentPage, long totalCount, int pageSize, List<News> list, String board_filterBy) {
	...
	public ListResult(int currentPage, long totalCount, int pageSize, List<News> list, String board_filterBy, String board_c_code, String board_searchName) {
		this.currentPage = currentPage;
		this.totalCount = totalCount;
		this.pageSize = pageSize;
		this.list = list;
