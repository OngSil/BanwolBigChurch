...
<body>
    ...
    <div class="container-fluid bg-light py-6">
        <div class="container">
            ...
            <div class="section-header text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
         	...
         	<form method="post" action="news_write.do" enctype="multipart/form-data">
	            <label for="subject">제목 :</label>
	            <input type="text" id="subject" name="subject" style="width:95%;margin-bottom:2%">
	            
	            <label for="writer">글쓴이 :</label>
	            <input type="text" id="writer" name="writer" style="width:25%;margin-bottom:2%;margin-right:9.5%" disabled> 
	            
	            <label for="createTime">작성일 :</label>
	            <input type="text" id="createTime" name="createTime"  style="width:25%;margin-bottom:2%;margin-right:9.5%" disabled>
	            
	            <textarea style="width:100%;height:300px" id="contents" name="contents"></textarea>
	            
	            <label for="file">파일첨부</label>
	            <input type="file" id="file" name="file" readonly="readonly" onchange="setFileNm()">
	            <input type="hidden" id="fileName" name="fileName">
	            
	            
	            
	            <div style="text-align:center">
				    <input type="submit" value="확인" class="details_btn">
				    
				</div>
			</form>
				<button class="details_btn">목록으로</button>
   ...
   <script type="text/javascript">
		...
		function newsWrite(){
			...
			formData.append("news", new Blob([JSON.stringify(data)] , {type: "application/json"}));
