...
<body>
    ...
    <div class="container-fluid page-header wow fadeIn" data-wow-delay="0.1s" style="background:url(../img/smartphone.jpg) center no-repeat; background-position:20% 40%;">
        <div class="container">
            <h1 class="display-3 mb-3 animated slideInDown" style="color:white">교회앨범</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a class="text-bodyX" style="color:white" href="#">앨범1</a></li>
                    <li class="breadcrumb-item"><a class="text-bodyX"  style="color:white" href="#">앨범2</a></li>
                    <li class="breadcrumb-item text-darkX active" style="color:white" aria-current="page">앨범3</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div id="albumFrame" class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="bg-light p-4">
                        <a class="d-block h5 lh-base mb-4" href="">1월 성령충만 기도회</a>
                        <div class="text-muted border-top pt-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="bg-light p-4">
                        <a class="d-block h5 lh-base mb-4" href="">반월큰교회 전성도 Praise</a>
                        <div class="text-muted border-top pt-4">
                            <small class="me-3"><i class="fa fa-user text-primary me-2"></i>Admin</small>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="bg-light p-4">
                        <a class="d-block h5 lh-base mb-4" href="">○○목사 초청 예배</a>
                        <div class="text-muted border-top pt-4">
                            <small class="me-3"><i class="fa fa-user text-primary me-2"></i>Admin</small>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="bg-light p-4">
                        <a class="d-block h5 lh-base mb-4" href="">전 성도 간증모임</a>
                        <div class="text-muted border-top pt-4">
                            <small class="me-3"><i class="fa fa-user text-primary me-2"></i>Admin</small>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="bg-light p-4">
                        <a class="d-block h5 lh-base mb-4" href="">2022 하계 수련회</a>
                        <div class="text-muted border-top pt-4">
                            <small class="me-3"><i class="fa fa-user text-primary me-2"></i>Admin</small>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="bg-light p-4">
                        <a class="d-block h5 lh-base mb-4" href="">2022 성탄 점등식</a>
                        <div class="text-muted border-top pt-4">
                            <small class="me-3"><i class="fa fa-user text-primary me-2"></i>Admin</small>
